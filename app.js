/* ============================================================
   Lirich Resources — Waste Logistics CRM (local-first PWA)
...
function renderHeader(){
  let sub, pill;
  if(S.role.kind==='operator'){
    sub = 'Waste logistics · 23 Gul Drive'; /* title already says Lirich Resources — don't repeat it */
...
function doPrintHTML(t){
  ...
  <body>
    ...
    ${body}
    ${sigBlock}
    <div class="do-field" style="margin-top:18px; font-size:10.5px; color:#888">Digital copy generated by Lirich Resources — not a substitute for the signed paper original during the trial period.</div>
  </body></html>`;
}
