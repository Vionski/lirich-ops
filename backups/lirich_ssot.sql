...
\restrict hqS7bElJNK3F2GeB0n6MiuVxO3Zy2Iy2eiuXQuhfHbwartn8lfEODNb42GdkoNJ
...
SELECT pg_catalog.setval('public.adjustments_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.audit_log_id_seq', 248, true);
...
SELECT pg_catalog.setval('public.fuel_log_id_seq', 15, true);
...
SELECT pg_catalog.setval('public.jobcard_overrides_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.odometer_log_id_seq', 19, true);
...
\unrestrict hqS7bElJNK3F2GeB0n6MiuVxO3Zy2Iy2eiuXQuhfHbwartn8lfEODNb42GdkoNJ
